...
inline VkSubmitInfo submitInfo() { return {.sType = VK_STRUCTURE_TYPE_SUBMIT_INFO}; }
...
inline VkVertexInputAttributeDescription vertexInputAttributeDescription(uint32_t binding, uint32_t location, VkFormat format,
                                                                         uint32_t offset) {
