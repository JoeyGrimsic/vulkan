...
best for me? Here are some of the \textit{libraries} I have come across:
\begin{itemize}
\item ENet
\item RakNet
\end{itemize}

\par But wait. What are you doing? I mean seriously, you aren't just
learning Vulkan now\textemdash you are approaching a decision that
would significantly impact the prototyping of your game. Clearly,
there is a lot of planning required to make this kind of decisiion in
a good way.

\par So what do you want this game to be? Well of course it would be
great if your game could ship on \textit{all} devices, but is that
realistic? I mean how much interfacing do you have to do with
PlayStation and XBox to get them working? Should you be concerned with
platform stuff right now? Well the whole reason I am considering
platforms is because I believe that choosing a networking solution
will wall me into a corner as soon as it happens. So the question is:
how many times do I want to rewrite? And after a rewrite, am I
getting too far off into the weeds? Of course I would love a game
that works on everything, but why bother? There's no reason to sit
around playing with platform-independant code when I could just pick
a platform and make 10X progress.

\par Okay, so the solution is Windows? But you're not even building
it on a Windows machine, you are building it on Arch Linux. Maybe
these two platforms can be kept in mind? Well that is a huge relief
because how big of a pain would it be to have all platforms in-mind.
...
\par What do we already know (other than we are going to use UDP)?
